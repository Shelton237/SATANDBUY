...
const NavbarPromo = () => {
  ...
  // On récupère la langue depuis le cookie ou on utilise la locale du router par défaut
  ...
  // Si on n'a pas de langue définie ou si elle ne correspond pas à la locale actuelle du router
  // On essaie de trouver la langue correspondante dans la liste des langues
  ...
  const handleLanguage = (selectedLang) => {
    ...
    // On change de locale via le router Next.js
        ...
        <div className="max-w-screen-2xl mx-auto px-3 sm:px-10 h-12 flex justify-between items-center">
          ...
          <div className="flex">
            ...
            <div className="dropdown">
              <div
                className={`flot-l flag ${activeLang?.flag?.toLowerCase()}`}
              ></div>
